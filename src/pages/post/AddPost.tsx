...
const AddPost = () => {
    ...
    const { values, errors, handleSubmit, setFieldValue, touched } = useFormik({
        initialValues: { title: '', description: '', post: '', thumbnail: "", mainPhoto: "", images: "" },
                        ...
                        <div className='add-post-wrapper'>
                            ...
                            <div className='text-center mt-3'>
                                <button disabled={isLoading} onClick={() => {handleSubmit()}} className='btn-block btn btn-primary'>
                                    { !isLoading ? <><span>Submit</span></>  : <><span><div className="spinner-border text-light spinner-border-sm"></div></span></> }
                                </button>
                            </div>
                        </div>
